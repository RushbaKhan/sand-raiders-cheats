...
const steps = [
  {
    ...
    desc: 'Complete your purchase and get instant access. Right after payment, your order page shows the loader download and setup instructions — plus a video guide.',
    icon: (
  ...
  },
  {
    num: '03',
    title: 'Load & Dominate',
    desc: 'Open the loader, launch SAND: Raiders of Sophie, and press OK inside the game. ESP, aimbot, and triggerbot are active. Dominate every raid.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
